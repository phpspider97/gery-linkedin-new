...
const StaffList = () => {
    ...
    const handleClickOpenDialog = (id=0) => {
        ...
        if(id != 0){  
            axios.get(`${API_PATH}/api/user-role/${id}`).then((response) => {  
    ...
    const fetchData = async (pageNumber = 1) => { 
        const roleRes = await axios.get(`${API_PATH}/api/user-role?page=${pageNumber}&record_count=10`);  
        setRows(roleRes.data.data);
        setRoleData(roleRes.data.data)
        const rolePaginationRes = await axios.get(`${API_PATH}/api/user-role?page=${pageNumber}&record_count=10`);
    ...
    //console.log('setRoleData',roleData)
    return (
            ...
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                        ...
                        <AddData open={open} getRoleData={roleData} handleCloseDialog={handleCloseDialog} />
                    </Grid>
                </Grid>
            </CardContent>
