...
const AdminRole = Loadable(lazy(() => import('views/admin/Role')));
const AdminStaff = Loadable(lazy(() => import('views/admin/Staff')));
const AdminUser = Loadable(lazy(() => import('views/admin/User')));
const HubSpotData = Loadable(lazy(() => import('views/admin/Hubspot')));

const UserDashboard = Loadable(lazy(() => import('views/user/Dashboard')));
//const CommingSoon = Loadable(lazy(() => import('views/user/CommingSoon')));
const CommingSoon = Loadable(lazy(() => import('views/pages/maintenance/ComingSoon/ComingSoon2')));
const UserAccountAds = Loadable(lazy(() => import('views/user/Account')));
const UserAccount = Loadable(lazy(() => import('views/user/Manager/Account')));
const UserCampaignGroup = Loadable(lazy(() => import('views/user/Manager/CampaignGroup')));
const UserCampaign = Loadable(lazy(() => import('views/user/Manager/Campaign')));
const UserAds = Loadable(lazy(() => import('views/user/Manager/Ads')));
const AdsOverview = Loadable(lazy(() => import('views/user/Overview')));
const UserProfile = Loadable(lazy(() => import('views/user/Profile')));
const Hubspot = Loadable(lazy(() => import('views/user/Hubspot')));
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/admin/user/hubspot/:userID',
            element: <HubSpotData />
        },
        {
            path: '/user',
            element: <UserAccountAds />
        },
        {
            path: '/user/account',
            element: <UserAccount />
        ...
        {
            path: '/user/campaign-group',
            element: <UserCampaignGroup />
        },
        {
            path: '/user/campaign/:IDS',
            element: <UserCampaign />
        },
        {
            path: '/user/creative/:IDS',
            element: <UserAds />
        },
        {
            path: '/user/overview',
