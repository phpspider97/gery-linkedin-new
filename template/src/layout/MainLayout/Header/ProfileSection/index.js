...
const ProfileSection = () => {
    ...
    const [settingLink,setSettingLink] = useState('/user/profile');
    /**
     * anchorRef is used on different components and specifying one type leads to other components throwing an error
     * */
    useEffect(() => {
        if(is_admin == 'admin'){
            setSettingLink('/admin/profile')
        }
    }, []);
                                            ...
                                            <Box sx={{ p: 2, pt: 0 }}>
                                                ...
                                                >
                                                    <ListItemButton
                                                        ...
                                                        onClick={(event) => handleListItemClick(event, 0, settingLink )}
                                                    >
                                                        <ListItemIcon>
