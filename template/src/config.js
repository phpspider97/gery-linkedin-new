...
export var DASHBOARD_PATH 

export const HORIZONTAL_MAX_ITEM = 6;

 export const API_PATH = 'http://127.0.0.1:8000';
 // export const API_PATH = 'http://linkedin-api2.itechnolabs.tech';
 // export const API_PATH = 'https://www.pipelight.io';
 //export const API_PATH = 'https://api.pipelight.io';
